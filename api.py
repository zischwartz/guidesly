...
class InputElementResource(ModelResource):
	card= fields.ForeignKey(CardResource, 'card')
	default_action= fields.ForeignKey(ActionResource, 'default_action', full=True, null=True)
	class Meta:
...
# Accidental different version, caused card PUTs to fail.
# ###########################################################
# from tastypie.resources import ModelResource
# 
# from guides.models import *
...
# class CardResource(ModelResource):
# 	mediaelements = fields.ToManyField('api.MediaElementResource', 'mediaelement_set', full=True, readonly=True, null=True )#, readonly=True))
# 	inputelements = fields.ToManyField('api.InputElementResource', 'inputelement_set', full=True)
# 	class Meta:
# 		authorization = Authorization()
# 		# always_return_data = True
# 		# allowed_methods =   ['get', 'post', 'put', 'delete']
...
# 			# statics.append("id")
# 			# statics.append(el['resource_uri'])
# 		bundle.data['mediaelements']=statics
# 		# logger.debug('*******************************************************')
# 		# logger.debug(bundle.data['mediaelements'])
# 		return bundle
# 	
...
# 		authorization = Authorization()
# 		
# 	# def hydrate_interactiveelement(self, bundle):
# 
