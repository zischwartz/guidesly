...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('fileupload_userfile', (
            ...
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fileupload.Image'], null=True, blank=True)),
            ('thumb_url', self.gf('django.db.models.fields.URLField')(max_length=200, blank=True)),
            ('medium_url', self.gf('django.db.models.fields.URLField')(max_length=200, blank=True)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('fileupload_image')

        # Deleting model 'UserFile'
        db.delete_table('fileupload_userfile')
