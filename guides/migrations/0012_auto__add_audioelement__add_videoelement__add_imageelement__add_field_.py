...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('guides_audioelement', (
            ...
            ('keep_playing', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        ...
        db.create_table('guides_imageelement', (
            ('staticelement_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['guides.StaticElement'], unique=True, primary_key=True)),
            ('is_background', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('guides', ['ImageElement'])

        # Adding field 'StaticElement.is_primary'
        db.add_column('guides_staticelement', 'is_primary', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'StaticElement.is_primary'
        db.delete_column('guides_staticelement', 'is_primary')
    ...
    models = {
        ...
        'guides.audioelement': {
            ...
            'keep_playing': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'guides.imageelement': {
            ...
            'is_background': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'staticelement_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['guides.StaticElement']", 'unique': 'True', 'primary_key': 'True'})
        },
