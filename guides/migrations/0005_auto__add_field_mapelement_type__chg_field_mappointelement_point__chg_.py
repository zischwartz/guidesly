...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MapElement.type'
        db.add_column('guides_mapelement', 'type', self.gf('django.db.models.fields.CharField')(default='map', max_length=100), keep_default=False)

        # Changing field 'MapPointElement.point'
        db.alter_column('guides_mappointelement', 'point', self.gf('django.db.models.fields.IntegerField')(max_length=500))

        # Changing field 'MapPointElement.manual_addy'
        db.alter_column('guides_mappointelement', 'manual_addy', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))


    def backwards(self, orm):
        
        # Deleting field 'MapElement.type'
        db.delete_column('guides_mapelement', 'type')

        # Changing field 'MapPointElement.point'
        db.alter_column('guides_mappointelement', 'point', self.gf('django.db.models.fields.CharField')(max_length=500))

        # User chose to not deal with backwards NULL issues for 'MapPointElement.manual_addy'
        raise RuntimeError("Cannot reverse this migration. 'MapPointElement.manual_addy' and its values cannot be restored.")
