...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Guide.text_slugs_for_slides'
        db.add_column('guides_guide', 'text_slugs_for_slides', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Guide.number_of_slides'
        db.add_column('guides_guide', 'number_of_slides', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Changing field 'Slide.guide'
        db.alter_column('guides_slide', 'guide_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['guides.Guide'], null=True))


    def backwards(self, orm):
        
        # Deleting field 'Guide.text_slugs_for_slides'
        db.delete_column('guides_guide', 'text_slugs_for_slides')

        # Deleting field 'Guide.number_of_slides'
        db.delete_column('guides_guide', 'number_of_slides')

        # User chose to not deal with backwards NULL issues for 'Slide.guide'
        raise RuntimeError("Cannot reverse this migration. 'Slide.guide' and its values cannot be restored.")
    ...
    models = {
        ...
        'guides.guide': {
            ...
            'number_of_slides': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
