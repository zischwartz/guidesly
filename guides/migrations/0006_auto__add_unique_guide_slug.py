...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Guide', fields ['slug']
        db.create_unique('guides_guide', ['slug'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Guide', fields ['slug']
        db.delete_unique('guides_guide', ['slug'])
