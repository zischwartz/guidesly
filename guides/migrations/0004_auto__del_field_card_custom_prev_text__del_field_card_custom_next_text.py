...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Card.custom_prev_text'
        db.delete_column('guides_card', 'custom_prev_text')

        # Deleting field 'Card.custom_next_text'
        db.delete_column('guides_card', 'custom_next_text')

        # Adding field 'Card.big_media'
        db.add_column('guides_card', 'big_media', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'MediaElement.big'
        db.delete_column('guides_mediaelement', 'big')


    def backwards(self, orm):
        
        # Adding field 'Card.custom_prev_text'
        db.add_column('guides_card', 'custom_prev_text', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Card.custom_next_text'
        db.add_column('guides_card', 'custom_next_text', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Deleting field 'Card.big_media'
        db.delete_column('guides_card', 'big_media')

        # Adding field 'MediaElement.big'
        db.add_column('guides_mediaelement', 'big', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)
    ...
    models = {
        ...
        'guides.card': {
            ...
            'big_media': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
