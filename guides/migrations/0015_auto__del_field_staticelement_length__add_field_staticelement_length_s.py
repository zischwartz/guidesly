...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'StaticElement.length'
        raise RuntimeError("Cannot reverse this migration. 'StaticElement.length' and its values cannot be restored.")
