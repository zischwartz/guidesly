...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MultipleChoice.inquiry'
        db.add_column('guides_multiplechoice', 'inquiry', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['guides.MultipleChoiceInquiry']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MultipleChoice.inquiry'
        db.delete_column('guides_multiplechoice', 'inquiry_id')
