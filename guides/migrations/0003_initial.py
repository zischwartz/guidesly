...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('guides_card', (
            ...
            ('primary_media', self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='primary_media', null=True, blank=True, to=orm['guides.MediaElement'])),
    ...
    models = {
        ...
        'guides.card': {
            ...
            'primary_media': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'related_name': "'primary_media'", 'null': 'True', 'blank': 'True', 'to': "orm['guides.MediaElement']"}),
