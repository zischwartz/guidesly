...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('guides_card', 'slug', self.gf('autoslug.fields.AutoSlugField')(default=datetime.date(2011, 9, 9), unique_with=(), max_length=50, populate_from=None))


    def backwards(self, orm):
        
        # Changing field 'Card.slug'
        db.alter_column('guides_card', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True))
