...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Guide.tags'
        db.add_column('guides_guide', 'tags', self.gf('tagging.fields.TagField')(default=''), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Guide.tags'
        db.delete_column('guides_guide', 'tags')
