...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Slide.default_next_slide'
        db.add_column('guides_slide', 'default_next_slide', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['guides.Slide']), keep_default=False)

        # Adding field 'Slide.default_prev_slide'
        db.add_column('guides_slide', 'default_prev_slide', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['guides.Slide']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Slide.default_next_slide'
        db.delete_column('guides_slide', 'default_next_slide_id')

        # Deleting field 'Slide.default_prev_slide'
        db.delete_column('guides_slide', 'default_prev_slide_id')
