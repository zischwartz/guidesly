...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Guide.slug'
        db.alter_column('guides_guide', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=250))

        # Changing field 'StaticElement.file'
        db.alter_column('guides_staticelement', 'file_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fileupload.UserFile']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Guide.slug'
        db.alter_column('guides_guide', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True))
