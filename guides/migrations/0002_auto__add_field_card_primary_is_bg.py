...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Card.primary_is_bg'
        db.add_column('guides_card', 'primary_is_bg', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Card.primary_is_bg'
        db.delete_column('guides_card', 'primary_is_bg')
