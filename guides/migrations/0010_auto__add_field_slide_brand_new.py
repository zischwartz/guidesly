...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Slide.brand_new'
        db.add_column('guides_slide', 'brand_new', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Slide.brand_new'
        db.delete_column('guides_slide', 'brand_new')
