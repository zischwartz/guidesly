...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'MultipleChoiceInquiry.choices'
        db.delete_column('guides_multiplechoiceinquiry', 'choices_id')


    def backwards(self, orm):
        
        # Adding field 'MultipleChoiceInquiry.choices'
        db.add_column('guides_multiplechoiceinquiry', 'choices', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['guides.MultipleChoices'], null=True, blank=True), keep_default=False)
