...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('guides_guide', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique_with=(), max_length=50, populate_from=None))


    def backwards(self, orm):
        
        # Changing field 'Guide.slug'
        db.alter_column('guides_guide', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=250, unique=True))
