...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('guides_card', (
            ...
            ('theme', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['guides.Theme'], null=True, blank=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('custom_prev_text', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('custom_next_text', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ))
        ...
        db.create_table('guides_mappointelement', (
            ...
            ('manual_addy', self.gf('django.db.models.fields.CharField')(max_length=100)),
