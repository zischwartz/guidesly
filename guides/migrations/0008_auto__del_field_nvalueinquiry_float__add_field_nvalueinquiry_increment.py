...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'NValueInquiry.float'
        db.delete_column('guides_nvalueinquiry', 'float')

        # Adding field 'NValueInquiry.increment_by'
        db.add_column('guides_nvalueinquiry', 'increment_by', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'NValueInquiry.default_value'
        db.add_column('guides_nvalueinquiry', 'default_value', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Changing field 'NValueInquiry.min_value'
        db.alter_column('guides_nvalueinquiry', 'min_value', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'NValueInquiry.max_value'
        db.alter_column('guides_nvalueinquiry', 'max_value', self.gf('django.db.models.fields.FloatField')(null=True))

        # Adding field 'TValueInquiry.default_value'
        db.add_column('guides_tvalueinquiry', 'default_value', self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'NValueInquiry.float'
        db.add_column('guides_nvalueinquiry', 'float', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Deleting field 'NValueInquiry.increment_by'
        db.delete_column('guides_nvalueinquiry', 'increment_by')

        # Deleting field 'NValueInquiry.default_value'
        db.delete_column('guides_nvalueinquiry', 'default_value')

        # User chose to not deal with backwards NULL issues for 'NValueInquiry.min_value'
        raise RuntimeError("Cannot reverse this migration. 'NValueInquiry.min_value' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'NValueInquiry.max_value'
        raise RuntimeError("Cannot reverse this migration. 'NValueInquiry.max_value' and its values cannot be restored.")

        # Deleting field 'TValueInquiry.default_value'
        db.delete_column('guides_tvalueinquiry', 'default_value')
