...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Guide', fields ['title']
        db.create_unique('guides_guide', ['title'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Guide', fields ['title']
        db.delete_unique('guides_guide', ['title'])
